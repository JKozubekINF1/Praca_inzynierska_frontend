...
export const announcementService = {
    ...
    activate: async (id: number) => {
        await axios.post(`${API_BASE_URL}/api/Announcements/${id}/activate`, {}, { withCredentials: true });
    },

    renew: async (id: number) => {
        await axios.post(`${API_BASE_URL}/api/Announcements/${id}/renew`, {}, { withCredentials: true });
    },
