...
export const AnnouncementForm: React.FC<AnnouncementFormProps> = ({ 
    ...
    const {
        category, setCategory, baseData, vehicleData, partData, 
        photos, features, coords, 
        ...
        handleLocationBlur, handleMapClick
    } = form;
            ...
            <form onSubmit={onSubmit} className="space-y-6">
                <div>
                    ...
                    <select 
                        ...
                        className={`${inputClass} ${title.includes("Edytuj") ? 'bg-gray-100 cursor-not-allowed' : ''}`}
                    >
                    ...
                    <>
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input name="title" value={baseData.title} onChange={handleBaseChange} className={inputClass} maxLength={100} placeholder="Np. BMW E46 320d" />
                        ...
                        {category === "Pojazd" && (
                            <div className="mt-6 border-t pt-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div><label className={labelClass}>Przebieg (km)</label><input type="number" name="mileage" value={vehicleData.mileage} onChange={handleVehicleChange} className={inputClass} /></div>
                                    ...
                                    <div><label className={labelClass}>Pojemność (cm3)</label><input type="number" name="engineCapacity" value={vehicleData.engineCapacity} onChange={handleVehicleChange} className={inputClass} /></div>
                                    <div>
                        ...
                        <div className="pt-8 pb-4">
                            <button type="submit" disabled={loading} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-lg disabled:opacity-50 transition shadow-lg text-lg">
