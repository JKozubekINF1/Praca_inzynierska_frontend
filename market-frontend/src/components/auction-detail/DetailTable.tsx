            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-2">
                ...
                {announcement.category === 'Pojazd' && announcement.vehicleDetails && (
                    <>
                        ...
                        <DetailRow label="Przebieg" value={announcement.vehicleDetails.mileage ? `${announcement.vehicleDetails.mileage.toLocaleString()} km` : null} />
                        <DetailRow label="Pojemność" value={announcement.vehicleDetails.engineCapacity ? `${announcement.vehicleDetails.engineCapacity} cm³` : null} />
                        <DetailRow label="Moc" value={announcement.vehicleDetails.enginePower ? `${announcement.vehicleDetails.enginePower} KM` : null} />
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {announcement.features.map((feature, index) => (
                            <span key={index} className="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium bg-blue-50 text-blue-700 border border-blue-100">
