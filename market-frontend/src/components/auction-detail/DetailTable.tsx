        ...
        {announcement.category === 'Pojazd' && announcement.vehicleDetails && (
          <>
            ...
            <DetailRow
              label="Przebieg"
              value={
                announcement.vehicleDetails.mileage
                  ? `${announcement.vehicleDetails.mileage.toLocaleString()} km`
                  : null
              }
            />
            <DetailRow
              label="Pojemność"
              value={
                announcement.vehicleDetails.engineCapacity
                  ? `${announcement.vehicleDetails.engineCapacity} cm³`
                  : null
              }
            />
            <DetailRow
              label="Moc"
              value={
                announcement.vehicleDetails.enginePower
                  ? `${announcement.vehicleDetails.enginePower} KM`
                  : null
              }
            />
