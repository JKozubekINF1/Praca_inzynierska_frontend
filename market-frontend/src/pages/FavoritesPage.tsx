                    ...
                    {visibleFavorites.map((item) => (
                        ...
                        >
                            <div className="aspect-[4/3] bg-gray-200 relative">
                                {item.photoUrl ? (
                                    <img 
                                        src={item.photoUrl.startsWith('http') ? item.photoUrl : `${API_BASE_URL}${item.photoUrl}`} 
                                        alt={item.title} 
                            ...
                            <div className="p-4">
                                ...
                                <p className="text-blue-600 font-bold text-lg">{item.price.toLocaleString('pl-PL')} PLN</p>
